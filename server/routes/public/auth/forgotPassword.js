 ...
 * - email saisie
 * - email au bon format
 * - email correspond à un utilisateur de notre bdd
 * @type {forgotPassword}
 */
module.exports = forgotPassword = async (req, res, next) => {
    try {
        const email = req.body.email; //récupération de l'email de l'utilisateur
        ...
        if(!studentExist){
            ...
            //aucun étudiant trouvé : on vérifie s'il s'agit de l'admin
